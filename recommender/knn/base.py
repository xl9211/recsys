...
class BaseItemCandidateStrategy(object):
    """
...
#===========================
# Base User Candidate Strategy
class BaseUserCandidateStrategy(object):
    """
    Base implementation for retrieving
    all users that could possibly be select as part of the neighborhood.
    """
    def candidate_users(self, user_id, data_model, n_similarity='user_similarity',
