...
class MatrixFactorBasedRecommender(SVDRecommender):
    ...
    #>>> from scikits.crab.recommenders.knn.item_strategies import NearestItemStrategy
    ...
    #>>> items_strategy = NearestItemStrategy()
    ...
    -----------
    """
    def __init__(self, model, item_strategy=None,
    ...
    def _init_models(self):
        ...
        self.user_factors = np.zeros(shape=(num_users, self.n_features), dtype=float)
        self.item_factors = np.zeros(shape=(num_items, self.n_features), dtype=float)
